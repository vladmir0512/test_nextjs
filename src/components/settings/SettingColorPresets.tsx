...
import { changeColor, useTheme } from "@/redux/slices/theme";
import { colorPresets, type PresetColors } from "@/theme/presets";
...
export default function SettingColorPresets() {
  ...
  const { activeColorPreset } = useTheme();

  const onChangeColor = (event: React.ChangeEvent<HTMLInputElement>) =>
    dispatch(changeColor(event.target.value as PresetColors));
    ...
    >
      ...
      >
        {colorPresets.map((color) => {
          ...
          const isSelected = activeColorPreset === colorName;
