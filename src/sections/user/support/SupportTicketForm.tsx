...
import supportSchema from "@/server/user/support/schema";
...
type FormValues = UserApiInputs["support"]["createTicket"];
const SupportTicketForm = ({ id }: Props) => {
  ...
  const methods = useForm({
    resolver: zodResolver(supportSchema.createTicket),
    defaultValues,
  });
  const { mutate, isLoading: isSubmitting } =
    userApi.support.createTicket.useMutation();
